...
![1-broken-input-1](./1-broken-input-1.png)
...
![2-set-input-value-1](./2-set-input-value-1.png)
...
![3-set-initial-value-1](./3-set-initial-value-1.png)
...
![4-update-state](./4-update-state.png)
...
![5-fixed-state-update](./5-fixed-state-update.png)
